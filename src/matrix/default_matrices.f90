...
!--------------------------------------------------------------------------!
    ...
    procedure(matvec_kernel), pointer, nopass, private :: matvec_add_impl
    procedure(matvec_kernel), pointer, nopass, private :: matvec_t_add_impl
...
! The parent-class sparse_matrix provides a default, if not very optimal,
