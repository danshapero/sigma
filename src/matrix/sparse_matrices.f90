...
!==========================================================================!
!==========================================================================!
!====     This module contains data types and routines that wrap all   ====!
!==== the atomic sparse matrix types and operations. This includes     ====!
!==== factory methods and the wrapper type sparse_matrix.              ====!
!====     Factory methods take in a string or integer describing the   ====!
!==== name of a sparse matrix storage format and return a pointer to a ====!
!==== sparse matrix in that format.                                    ====!
!====     The sparse_matrix type is used as a wrapper around all the   ====!
!==== basic matrix types. It contains an array of polymorphic pointers ====!
!==== to other sparse matrices. Its simplest use is as a wrapper       ====!
!==== around a single sparse matrix. Rather than require the user to   ====!
...
!==========================================================================!
!========                                                          ========!
!====               Methods for sparse_matrix objects                  ====!
!========                                                          ========!
!==========================================================================!
